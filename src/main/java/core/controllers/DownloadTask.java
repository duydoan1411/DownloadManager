...
public class DownloadTask extends Task<Long>
{
    ...
    public DownloadTask(FileInformation downloadedFile, ItemDownloadMonitorController controller)
    {
        this.controller = controller;
        this.startPostion = downloadedFile.getDownloaded() > 0 ? downloadedFile.getDownloaded() : 0;
        this.download = downloadedFile;
        this.fileInformationDAO = new FileInformationDAO();
        try
        {
    ...
    protected void succeeded() // Calls When Task Finished Successfully
    {
        ...
        fileInformationDAO.update(download);
